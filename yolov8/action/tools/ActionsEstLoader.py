...
from yolov8.action.Actionsrecognition.Models import TwoStreamSpatialTemporalGraph
from yolov8.action.tools.pose_utils import normalize_points_with_size, scale_pose
...
class TSSTG(object):
    ...
    def __init__(self, weight_file=None, class_names=None, device='cuda'):
